...
public class SecurityPermission implements Permission {
  ...
  public void loadSecurityPermission(HttpSecurity http) throws Exception {
    ...
    // public
  	...
  	http.authorizeRequests().antMatchers("GET", "/api/rest/main/ProcessaURLBoleto/").permitAll();
  	http.authorizeRequests().antMatchers("GET", "/api/rest/main/RedirecionaURL/").permitAll();
